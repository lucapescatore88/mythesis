...
The selection process, described in the following subsubsections,
...
signal efficiency loss. In the following subsections are described the main sources of peaking background.
...
Some $\Bu \to K^+ \ll$ decays can contaminate the upper \Bz mass sideband if they are combined
...
In Fig.~\ref{fig:phiplots} the invariant mass distribution of the three-body $K\mumu$ system, $m(K\mu\mu)$, is shown.
