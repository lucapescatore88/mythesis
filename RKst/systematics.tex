...
Furthermore in all case where a simulated sample is used and smoothed to obtain a PDF
...
Ball-Zwicky (6)         & -0.3          & 1.0          & 0.2 \\
%%Melikhov Stech  		& 4.8          & -3.2          & 6.8 \\
Colangelo 2pt QCD (3)	& 0.4          & 0.4 	        & 0.8 \\
Melikhov lattice  (4)   & 0.1          & -0.4          & -0.4 \\
\end{tabular}
