...
\input{Lmumu/introduction}
\input{Lmumu/selection}
\input{Lmumu/fit}
\input{Lmumu/efficiency}
\input{Lmumu/systematics}
%\input{Lmumu/summaryBR}
\input{Lmumu/afbmethod}
\input{Lmumu/ang_fit_strategy}
\input{Lmumu/ang_sys_and_results}
...
%\cleardoublepage
\label{par:RKst}
\input{RKst/introduction}
\input{RKst/selection}
\input{RKst/fit}
\input{RKst/efficiency}
\input{RKst/systematics}
\input{RKst/result}
...
\appendix
%\part{Appendices}
\input{Lmumu/angularAppendix}
%\input{Lmumu/appendixNNImportance}
\input{Lmumu/appMCdataComp}
\input{Lmumu/appendix_Lb_sys}
\input{Lmumu/new_Lb_predictions}
\input{RKst/app_MC_fits}
%\input{app_extra}
