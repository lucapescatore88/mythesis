...
\newcommand{\thesistitle}{ A search for new physics in $b\rightarrow s \ell\ell$ transitions in mesonic and baryonic systems at the LHCb experiment.
 } %Fill in title
...
%%%%%%%%%%%%%  Lb->Lmumu
\include{Lmumu/introduction_th}
\include{Lmumu/selection_th}
\include{Lmumu/fit}
\include{Lmumu/efficiency}
\include{Lmumu/systematics}
\include{Lmumu/summaryBR}
\include{Lmumu/afbmethod}
\include{Lmumu/ang_fit_strategy}
\include{Lmumu/ang_sys_and_results}

%%%%%%%%%%%%%  RKst

\include{RKst/introduction}
\include{RKst/selection}
\include{RKst/fit}
\include{RKst/efficiency}
\include{RKst/systematics}
\include{RKst/result}
...
\bibliography{thesis,lmumu,LHCb-PAPER,LHCb-TDR,LHCb-CONF,LHCb-DP}
\clearpage

%%%%%%%%%% Appendix %%%%%%%%%%
\appendix
%\chapter{Appendices}
\include{Lmumu/angularAppendix}
%\include{Lmumu/appendixNNImportance}
\include{Lmumu/appMCdataComp}
\include{Lmumu/appendix_Lb_sys}
%\include{Lmumu/appendixAngObservables}
