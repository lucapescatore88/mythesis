...
%
%Under ``adds" is shown how much discrimintating power a variable adds with respect to the previous ones.
...
conditions in the two years respectively. %Only triggered events are used for training.
