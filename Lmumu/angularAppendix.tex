...
\phantomsection\label{ap:LbLmumuAngular}
...
\section{Two-dimensional angular distribution parameters}
...
%
    \begin{equation}\label{eq:jpsiLambdaRate}
      ...
      \end{equation}
%where $f_{1i}$, $f_{2i}$ and $F_i$ are listed in Tab.~\ref{tab:LbJpsiLAngular}. 
...
$\vec{p_{inc}}$ and $\vec{p}_{\Lb}$ are the momenta of incident proton and \Lb in the centre of mass system.
