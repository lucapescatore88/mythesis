...
the physical region. If the minimum of the log-likelihood is found to be outside the physical region, the closest point on
...
%especially if the measured value is close to the boundary. 
...
The confidence interval at $k\%$ is given by the points where the fixed-to-free likelihood ratio is bigger in data than
...
%While in principle one could take this into account
...
As a large number of free parameters is difficult to constrain with the very limited statistics available, 
