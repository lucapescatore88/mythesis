...
$\sin\theta\sin\theta_{2}\cos\theta_{2}\sin\phi_{2}$
 ...
 $\sin\theta_{1}\sin\theta_{2}\cos\theta_{2}\sin(\phi_{1}+\phi_{2})$
       \\
             \hline\hline
             \end{tabular}
\caption{Different terms desribing angular distributions of \Lb\ra\jpsi\Lz decays by
...
The distribution depends on the \Lz decay asymmetry parameter, $\alpha_\Lz$, the production polarization
...
The production polarization $P_b$ and magnitudes of $a_+$, $a_-$, $b_+$ and $b_-$ are measured in
...
The \qsq and angular dependances of the $\Lb\to\Lz\mumu$ decays are modelled based on
Ref.~\cite{Gutsche:2013pp}, where the angular distribution for unpolarized \Lb production
is defined as
\begin{eqnarray}
...
The production polarization is introduced by removing
...
Ref.~\cite{Detmold:2012vy}. Denoting LQCD form factors by $F_i^L$ and dimensionaless covariant quark model ones by
$f_i^{XX}$ we have
\begin{align}
...
the $Z$ mass, $\alpha_s(m_Z^2)=0.1185 \pm 0.0006$~\cite{PDG2012}, and we translate it to the scale $m_b^2$ by
\begin{equation}
