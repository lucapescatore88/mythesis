...
The reconstruction efficiency is subdivided into ``Detection" and ``Reconstruction and pre-selection" efficiencies.
...
\begin{table}
\centering
\caption{Absolute efficiency values for $\Lb\to\jpsi\Lz$; uncertainties are statistical.}
\begin{tabular}{$l^c^c}
\rowstyle{\bfseries}
